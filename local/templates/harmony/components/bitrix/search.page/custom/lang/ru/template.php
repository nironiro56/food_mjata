...
$MESS["CT_BSP_NOTHING_TO_FOUND"] = "К сожалению, по поисковому запросу на складе ничего не найдено.<br> Вы можете оставить запрос на поиск нужной запчасти, заполнив форму ниже";
