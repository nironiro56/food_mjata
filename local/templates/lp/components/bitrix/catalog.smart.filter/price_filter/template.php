...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> ">
	<div class="bx-filter-section container-fluid">
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<div class="row">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="col-md-12 col-xs-12 bx-filter-parameters-box bx-active">
						<span class="bx-filter-container-modef"></span>
            ...
            $showMin = $arItem["VALUES"]["MIN"]["HTML_VALUE"] ?? $arItem["VALUES"]["MIN"]["VALUE"];
            $showMax = $arItem["VALUES"]["MAX"]["HTML_VALUE"] ?? $arItem["VALUES"]["MAX"]["VALUE"];
