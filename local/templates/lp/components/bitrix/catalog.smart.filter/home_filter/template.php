...
<div class="bx-filter">
  ...
  <a class="noactive" href="#">6</a>
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="/kuhni<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter buildform_row jcfe">
			<?foreach($arResult["HIDDEN"] as $arItem):?>
			<input type="hidden" name="<?echo $arItem["CONTROL_NAME"]?>" id="<?echo $arItem["CONTROL_ID"]?>" value="<?echo $arItem["HTML_VALUE"]?>" />
			<?endforeach;?>
			<div class="buildform_filter">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="buildform_filter_item  bx-filter-parameters-box bx-active">
                        <? if($arItem['CODE'] == 'F_TYPE' && !empty($arItem["VALUES"])) { ?>
                            <?
                            reset($arItem["VALUES"]);
                            $firstVal = current($arItem["VALUES"]);
                            ?>
                        <div class="buildform_filter_type_current">
                            <img src="<?=$firstVal['FILE']['SRC']?>" alt="">
                            <p><?=$firstVal['VALUE']?></p>
                        </div>
                        <? } ?>
                        <div class="buildform_<?=mb_strtolower($arItem['CODE'], 'utf-8')?>">
						<span class="bx-filter-container-modef"></span>
									...
									<div class="col-xs-12">
                                        ...
                                        <? $n++; ?>
											...
											<label for="<?=$ar["CONTROL_ID"]?>"
                                                   ...
                                                   smartFilter.sSelectTypeFilter(this); /*BX.toggleClass(this, 'bx-active');*/"
                                                   data-img="<?=$ar["FILE"]["SRC"]?>"
                                                   data-value="<?=$ar["VALUE"]?>">
			...
			<div class="row">
				<div class="col-xs-12 bx-filter-button-box">
					<div class="bx-filter-block buildform_filter_item aife jcc">
						<div class="bx-filter-parameters-box-container buildform_filter_submit ">
                            <div class="buildform_filter_submit_poster">
                                <img src="/assets/img/pics/rightnow.png" alt="">
                            </div>
							<input
								class="btn btn-warning buildform_filter_submit_button"
								type="submit"
								id="set_filter"
								name="set_filter"
