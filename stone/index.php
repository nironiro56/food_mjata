...
$APPLICATION->SetTitle("Искусственный камень");
?>

<?$APPLICATION->IncludeComponent("bitrix:news", "catalog_stone", Array(
    ...
    "SEF_FOLDER" => "/stone/",	// Каталог ЧПУ (относительно корня сайта)
